                ...
                <div className="flex flex-col justify-center items-center relative">
                  ...
                  {showGif && (
                    <div>
                      ...
                      />
                      {showLight && (
                        <div className="absolute top-[20%] left-[-30%] transform -translate-y-1/2 scale-[100%] z-[30] opacity-60 animate-light-height">
                          {/* <img
                            src="/gift/open-gift/light-particle.gif"
                            alt=""
                            className="absolute top-[40%] left-[0%] transform -translate-y-1/2 scale-[100%] z-[10] opacity-10 animate-light-height mix-blend-color"
                          /> */}
                          <svg
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="relative ">
            <img
              ...
              alt=""
              className="scale-100 absolute top-[-40%] blur-xl"
              aria-hidden="true"
            />
