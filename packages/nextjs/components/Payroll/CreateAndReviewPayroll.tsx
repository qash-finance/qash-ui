    ...
    items: [
      {
        ...
        qty: payroll?.payrollCycle,
        amount: Number(payroll?.amount) * payroll?.payrollCycle,
      },
    ],
    subtotal: Number(payroll?.amount) * payroll?.payrollCycle,
    total: Number(payroll?.amount) * payroll?.payrollCycle,
...
const CreateAndReviewPayroll = () => {
  ...
  const [selectedToken, setSelectedToken] = useState<AssetWithMetadata | undefined>(undefined);
