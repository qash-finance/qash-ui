  ...
  return (
    ...
    >
      ...
      <div className="flex relative gap-1 justify-center items-center w-full p-1 rounded-2xl backdrop-blur-[15.35px] bg-[#012F87] bg-opacity-50 z-[1] max-sm:p-1">
        ...
        <button
          onClick={() => router.push("/group-payment")}
          className="cursor-pointer flex gap-1.5 justify-between items-center px-6 py-2.5 rounded-xl border-solid bg-blend-luminosity bg-[#204997] flex-[1_0_0] max-sm:px-4 max-sm:py-2"
        >
